...
%                     tmn(il, is, rip) =  calcErr(kernLRTest(c, Xtr, kernel, s, Xtr), Ytr);               
%                     vmn(il, is, rip)  = calcErr(kernLRTest(c, Xtr, kernel, s, Xvl), Yvl);
                elseif isequal(algorithm, 'lr')
                    c = linearLRTrain1(Xtr, Ytr, l, c);
                    tmn(il, is, rip) =  calcErrLR(linearLRTest(c, Xtr), Ytr);               
                    vmn(il, is, rip)  = calcErrLR(linearLRTest(c, Xvl), Yvl);
%                     tmn(il, is, rip) =  calcErr(linearLRTest(c, Xtr), Ytr);               
%                     vmn(il, is, rip)  = calcErr(linearLRTest(c, Xvl), Yvl);   
                else  
